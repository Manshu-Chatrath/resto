      ...
      return (
        <div className="hide extra2">
          <div className="extra-tab">
            ...
            <div className="extras">{this.breakup()}</div>
            <div className="cart-btn">
              <input name="extras" type="hidden" />
              <button id="cartt" onClick={this.handleCart} className="cart">
                Add To Cart
              </button>
            </div>
          ...
          <div key={item.id} className="article">
            ...
            <div className="buttons mt-2">
              <button
                ...
                style={{ width: "45%" }}
                onClick={(e) => {
                  this.props.view(item.id);
                  this.props.allextras(item.id);
                  setTimeout(() => {
                    this.toggler(item.title, item.recepie, item.url, item.id);
                  }, 500);
                }}>
                Add To Cart
              </button>
      ...
      return (
        <div className="items mt-4" key={cat.Category}>
          <div className="heading44">
            <h2 id={cat.Category} className="heading2">
              {cat.Category}
            </h2>
          </div>
          <hr style={{ borderTop: "1px solid #E5E5E5" }} />
          <div className="main">{this.main(cat.Category)}</div>
          <hr style={{ borderTop: "1px solid #E5E5E5" }} />
        </div>
      );
    });
